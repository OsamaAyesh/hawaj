// lib/core/routes/hawaj_routing/hawaj_routing_and_screens.dart
...
import '../../../features/common/map/presenation/pages/map_screen.dart';
import '../../../features/common/profile/domain/di/di.dart';
import '../../../features/common/profile/presentation/pages/contact_us_screen.dart';
import '../../../features/common/profile/presentation/pages/edit_profile_screen.dart';
import '../../../features/common/profile/presentation/pages/profile_screen.dart';
...
import '../../../features/providers/offers_provider/add_offer/presentation/pages/add_offer_provider_screen.dart';
import '../../../features/providers/offers_provider/register_company_offer_provider/domain/di/di.dart';
import '../../../features/providers/offers_provider/register_company_offer_provider/presentation/pages/register_company_offer_provider_screen.dart';
...
import 'hawaj_audio_service.dart';

/// ═══════════════════════════════════════════════════════════
/// 📱 HAWAJ SECTIONS - الأقسام الرئيسية في التطبيق
/// ═══════════════════════════════════════════════════════════
class HawajSections {
  static const String dailyOffers = "1"; // العروض اليومية
  static const String commercialContracts = "2"; // العقود التجارية
  static const String realEstates = "3"; // العقارات
  static const String jobs = "5"; // الوظائف
  static const String settingsSection = "6"; // الإعدادات
}

/// ═══════════════════════════════════════════════════════════
/// 🖥️ HAWAJ SCREENS - الشاشات بتسلسل تصاعدي موحد (1, 2, 3, 4...)
/// ═══════════════════════════════════════════════════════════
/// ═══════════════════════════════════════════════════════════
/// 🖥️ HAWAJ SCREENS - الشاشات بتسلسل تصاعدي موحد
/// ═══════════════════════════════════════════════════════════
/// ═══════════════════════════════════════════════════════════
/// 🖥️ HAWAJ SCREENS - الشاشات بتسلسل تصاعدي موحد
/// ═══════════════════════════════════════════════════════════
class HawajScreens {
  // ════════════════════════════════════════════════════════
  // 🎁 DAILY OFFERS SECTION (1) - قسم العروض اليومية
  // ════════════════════════════════════════════════════════
  static const String map = "1"; // 1- شاشة العروض اليومية (الخريطة)
  // static const String organizationDetails = "2"; // 2- شاشة المؤسسة (تفاصيل العروض) - NOT IMPLEMENTED YET
  static const String myCompaniesDailyOffer =
      "3"; // 3- شاشة إدارة العروض (قائمة المؤسسات)
  static const String createCompanyDailyOffer = "4"; // 4- شاشة إضافة المؤسسة
  // static const String organizationTabs = "5"; // 5- شاشة المؤسسة (العروض، الاشتراكات، التعديل) - NOT IMPLEMENTED YET
  // static const String organizationOffers = "6"; // 6- تبويب العروض - NOT IMPLEMENTED YET
  // static const String organizationSubscriptions = "7"; // 7- تبويب الاشتراكات - NOT IMPLEMENTED YET
  // static const String editOrganization = "8"; // 8- تبويب تعديل بيانات المؤسسة - NOT IMPLEMENTED YET
  // static const String editOffer = "9"; // 9- شاشة تعديل العرض - NOT IMPLEMENTED YET
  static const String addNewOffer = "10"; // 10- شاشة إضافة عرض جديد
  // static const String addSubscription = "11"; // 11- شاشة إضافة إشتراك جديد - NOT IMPLEMENTED YET

  // ════════════════════════════════════════════════════════
  // ⚙️ SETTINGS SECTION (6) - قسم الإعدادات
  // ════════════════════════════════════════════════════════
  static const String hawajStartScreen = "12"; // شاشة البداية
  static const String profileScreen = "13"; // الملف الشخصي
  static const String editProfileScreen = "14"; // تعديل الملف الشخصي
  static const String contactWithSupportScreen = "15"; // التواصل مع الدعم
  static const String privacyPolicyScreen = "16"; // سياسة الخصوصية

  // ════════════════════════════════════════════════════════
  // 🏢 REAL ESTATES SECTION (3) - قسم العقارات
  // ════════════════════════════════════════════════════════
  static const String realEstatesMap = "17"; // خريطة العقارات
  static const String myOwnerPropertys = "18"; // عقاراتي كمالك
  static const String addOwnerProperty = "19"; // إضافة عقار كمالك
  static const String getMyRealEstates = "20"; // عقاراتي كمزود خدمة
  static const String addRealEstates = "21"; // إضافة عقار كمزود خدمة

  // ════════════════════════════════════════════════════════
  // 💼 JOBS SECTION (5) - قسم الوظائف
  // ════════════════════════════════════════════════════════
  static const String jobsMap = "22"; // خريطة الوظائف
  // static const String addNewJob = "23"; // إضافة وظيفة جديدة - NOT IMPLEMENTED YET
  // static const String myJobPosts = "24"; // وظائفي المنشورة - NOT IMPLEMENTED YET
  // static const String jobApplications = "25"; // طلبات التوظيف - NOT IMPLEMENTED YET

  // ════════════════════════════════════════════════════════
  // 📋 COMMERCIAL CONTRACTS SECTION (2) - قسم العقود التجارية
  // ════════════════════════════════════════════════════════
  // static const String contractsList = "26"; // قائمة العقود - NOT IMPLEMENTED YET
  // static const String createContract = "27"; // إنشاء عقد - NOT IMPLEMENTED YET
  // static const String contractDetails = "28"; // تفاصيل العقد - NOT IMPLEMENTED YET

  // ════════════════════════════════════════════════════════
  // 🔧 LEGACY SCREENS (الشاشات القديمة - أرقام غير محجوزة)
  // ════════════════════════════════════════════════════════
  static const String manageOrganizations =
      "29"; // كانت اسمها manageOrganizations
  static const String addOrganization = "30"; // كانت اسمها addOrganization
  static const String addOffer = "31"; // كانت اسمها addOffer (نسخة قديمة)
}
...
/// ═══════════════════════════════════════════════════════════
/// ⚙️ ROUTE CONFIGURATION - إعدادات المسار
/// ═══════════════════════════════════════════════════════════
...
/// ═══════════════════════════════════════════════════════════
/// 🗺️ HAWAJ ROUTES - نظام التوجيه الرئيسي
/// ═══════════════════════════════════════════════════════════
class HawajRoutes {
  static final List<HawajRouteConfig> _routes = [
    ...
    // 3- شاشة إدارة العروض (قائمة المؤسسات)
    HawajRouteConfig(
      section: HawajSections.dailyOffers,
    ...
    HawajRouteConfig(
      section: HawajSections.settingsSection,
      screen: HawajScreens.contactWithSupportScreen,
      // "15"
    ...
    // ════════════════════════════════════════════════════════
    // 🏢 REAL ESTATES SECTION (3)
    // ════════════════════════════════════════════════════════
    HawajRouteConfig(
      section: HawajSections.realEstates,
      screen: HawajScreens.realEstatesMap,
      // "17"
    ...
    HawajRouteConfig(
      section: HawajSections.realEstates,
      screen: HawajScreens.addOwnerProperty,
      // "19"
    ...
    HawajRouteConfig(
      ...
      screen: HawajScreens.jobsMap,
      // "22"
      name: 'Jobs Map Screen',
      builder: (params) => const MapScreen(),
      transition: HawajTransition.fade,
      init: (params) {
        Get.put(HawajMapDataController(), permanent: true);
  ...
  /// ═══════════════════════════════════════════════════════
  /// 🔧 HELPER: Initialize Map Screen
  /// ═══════════════════════════════════════════════════════
  static void _initializeMapScreen() {
    // ✅ تهيئة HawajMapDataController
    if (!Get.isRegistered<HawajMapDataController>()) {
      Get.put(HawajMapDataController(), permanent: true);
      debugPrint('[HawajRouting] ✅ HawajMapDataController initialized');
    }

    // ✅ تهيئة MapController عبر Bindings
    if (!Get.isRegistered<MapController>()) {
      MapBindings().dependencies();
      debugPrint('[HawajRouting] ✅ MapBindings initialized');
    }
  }
  ...
  static HawajRouteConfig? findRoute(String section, String screen) {
    try {
      ...
      debugPrint('❌ [HawajRoutes] Route not found: $section-$screen');
      debugPrint('🚧 [HawajRoutes] Redirecting to Under Development...');
  ...
  /// ═══════════════════════════════════════════════════════
  /// 🚀 Navigate with Animation + Audio Handling
  /// ═══════════════════════════════════════════════════════
  static Future<void> navigateTo({
    ...
    if (route == null) {
      debugPrint('❌ [HawajRoutes] Critical Error: Cannot create route');
      return;
    }

    debugPrint('🚀 [HawajRoutes] Navigating to ${route.name}');
    debugPrint('📦 [HawajRoutes] Section: $section, Screen: $screen');
    debugPrint('📦 [HawajRoutes] Parameters: ${parameters ?? {}}');

    // ✅ Execute init() before navigation
    if (route.init != null) {
      try {
        debugPrint('⚙️ [HawajRoutes] Running init() for ${route.name}');
        route.init!(parameters);
        debugPrint('✅ [HawajRoutes] Finished init() for ${route.name}');
      } catch (e, s) {
        debugPrint('❌ [HawajRoutes] Error in init(): $e');
    ...
    try {
      audioService = Get.isRegistered<HawajAudioService>()
          ? Get.find<HawajAudioService>()
          : null;
    } catch (_) {
      audioService = null;
    }
    ...
    try {
      ...
      debugPrint('✅ [HawajRoutes] Navigation successful: ${route.name}');
    } catch (e, s) {
      debugPrint('❌ [HawajRoutes] Navigation failed: $e');
      debugPrintStack(stackTrace: s);
    }

    // 🎧 Restore audio after navigation
    if (wasPlaying && lastUrl != null) {
      Future.delayed(const Duration(milliseconds: 800), () async {
        try {
          await audioService?.playUrl(lastUrl);
          debugPrint('🎧 [HawajRoutes] Audio restored after navigation');
        } catch (e) {
          debugPrint('⚠️ [HawajRoutes] Failed to restore audio: $e');
        }
      });
    }
  }
  ...
  /// ═══════════════════════════════════════════════════════
  /// 🎨 Navigate to Under Development Screen
  /// ═══════════════════════════════════════════════════════
  ...
  static void printAllRoutes() {
    debugPrint('═══════════════════════════════════════════════');
    debugPrint('📱 Hawaj Routes Registry (${_routes.length} routes)');
    debugPrint('═══════════════════════════════════════════════');

    // تجميع الشاشات حسب القسم
    final routesBySection = <String, List<HawajRouteConfig>>{};
    for (var route in _routes) {
      routesBySection.putIfAbsent(route.section, () => []).add(route);
    }

    // طباعة كل قسم مع شاشاته
    routesBySection.forEach((section, routes) {
      debugPrint('\n📂 Section $section:');
      for (var route in routes) {
        debugPrint('   ├─ Screen ${route.screen}: ${route.name}');
      }
    });
