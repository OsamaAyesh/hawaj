...
part 'get_organization_item_with_out_offer_response.g.dart';

/// Represents an organization with its related offers.
@JsonSerializable()
class GetOrganizationItemWithOutOfferResponse {
  final String? id;
  ...
  GetOrganizationItemWithOutOfferResponse({
    this.id,
  ...
  factory GetOrganizationItemWithOutOfferResponse.fromJson(
    Map<String, dynamic> json,
  ) =>
      _$GetOrganizationItemWithOutOfferResponseFromJson(json);

  Map<String, dynamic> toJson() =>
      _$GetOrganizationItemWithOutOfferResponseToJson(this);
}
