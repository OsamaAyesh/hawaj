...
class ManageContractUserScreen extends StatefulWidget {
  const ManageContractUserScreen({super.key});

  @override
  State<ManageContractUserScreen> createState() =>
      _ManageContractUserScreenState();
}

class _ManageContractUserScreenState extends State<ManageContractUserScreen>
    with TickerProviderStateMixin {
  late AnimationController _controller;
  late Animation<double> _fade;
  late Animation<Offset> _slide;
  final appSettingsPrefs = instance<AppSettingsPrefs>();
  List<Map<String, String>> itemsManagerContracts = [];
  late List<VoidCallback> quickAccessActions;

  @override
  void initState() {
    super.initState();
    itemsManagerContracts = Constants.itemsManagerContracts;
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: GridView.builder(
                              ...
                              itemCount: itemsManagerContracts.length,
                              itemBuilder: (context, index) {
                                final item = itemsManagerContracts[index];
