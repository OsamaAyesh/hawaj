...
class UpdateProfileUseCase implements BaseUseCase<UpdateProfileRequest,WithOutDataModel> {
  final UpdateProfileRepository _repository;

  UpdateProfileUseCase(this._repository);

  @override
  Future<Either<Failure, WithOutDataModel>> execute(UpdateProfileRequest request) async {
    return await _repository.updateProfileData(
        request
    );
  }
}
