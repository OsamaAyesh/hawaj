...
class _MapScreenState extends State<MapScreen> {
            ...
            child: Obx(() {
              ...
              return Stack(
                children: [
                  ...
                  //     child: MapSectionsSwitcher(controller: sectionsC),
                  //   ),
                  // ),
  ...
  Widget _buildLoadingOverlay() {
    return Obx(() {
      // إما loading من offersC أو من sectionsC
      final isLoading =
