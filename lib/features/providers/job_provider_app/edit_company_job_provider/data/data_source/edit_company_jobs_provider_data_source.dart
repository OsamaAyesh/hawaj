...
import '../request/edit_company_jobs_provider_request.dart';

abstract class EditCompanyJobsProviderDataSource {
  Future<WithOutDataResponse> editCompanyJobsProvider(
      EditCompanyJobsProviderRequest request);
}

class EditCompanyJobsProviderDataSourceImplement
    implements EditCompanyJobsProviderDataSource {
  AppService _appService;

  EditCompanyJobsProviderDataSourceImplement(this._appService);
  ...
  Future<WithOutDataResponse> editCompanyJobsProvider(
    ...
    return await _appService.editCompanyJobsProvider(
      request.id,
