...
class ManagerCommercialContractsServicesProviderScreen extends StatefulWidget {
  const ManagerCommercialContractsServicesProviderScreen({super.key});

  @override
  State<ManagerCommercialContractsServicesProviderScreen> createState() =>
      _ManagerCommercialContractsServicesProviderScreenState();
}

class _ManagerCommercialContractsServicesProviderScreenState
    extends State<ManagerCommercialContractsServicesProviderScreen>
    with TickerProviderStateMixin {
  late AnimationController _controller;
  late Animation<double> _fade;
  late Animation<Offset> _slide;
  final appSettingsPrefs = instance<AppSettingsPrefs>();
  List<Map<String, String>> itemsManagerProviderContracts = [];
  late List<VoidCallback> quickAccessActions;

  @override
  void initState() {
    super.initState();
    itemsManagerProviderContracts = Constants.itemsManagerProviderContracts;
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: GridView.builder(
                              ...
                              itemCount: itemsManagerProviderContracts.length,
                              itemBuilder: (context, index) {
                                final item =
                                    itemsManagerProviderContracts[index];
