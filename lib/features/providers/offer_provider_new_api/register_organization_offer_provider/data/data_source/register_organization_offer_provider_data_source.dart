...
abstract class RegisterOrganizationOfferProviderDataSource {
  Future<WithOutDataResponse> registerOrganizationOfferProvider(
      RegisterOrganizationOfferProviderRequest request);
}

class RegisterOrganizationOfferProviderDataSourceImplement
    implements RegisterOrganizationOfferProviderDataSource {
  AppService _appService;

  RegisterOrganizationOfferProviderDataSourceImplement(this._appService);
