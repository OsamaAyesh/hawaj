...
abstract class UpdateOrganizationOfferProviderDataSource {
  Future<WithOutDataResponse> updateOrganizationOfferProvider(
      UpdateOrganizationOfferProviderRequest request);
}

class UpdateOrganizationOfferProviderDataSourceImplement
    implements UpdateOrganizationOfferProviderDataSource {
  final AppService _appService;

  UpdateOrganizationOfferProviderDataSourceImplement(this._appService);
  ...
  Future<WithOutDataResponse> updateOrganizationOfferProvider(
    ...
    return await _appService.registerOrganizationOfferProvider(
