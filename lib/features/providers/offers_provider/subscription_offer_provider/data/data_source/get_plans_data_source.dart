...
abstract class GetPlansDataSource {
  Future<PlanResponse> getPlansOfferProvider(
      );
}

class GetPlansDataSourceImplement implements GetPlansDataSource {
  AppService _appService;

  GetPlansDataSourceImplement(this._appService);
  ...
  Future<PlanResponse> getPlansOfferProvider(
    ...
    return await _appService.getPlansOfferProvider();
  }
}
