...
import '../request/create_offer_provider_request.dart';


abstract class CreateOfferProviderDataSource{
  Future<WithOutDataResponse> createOfferProvider(
      CreateOfferProviderRequest request);
}

class CreateOfferProviderDataSourceImplement
    implements CreateOfferProviderDataSource {
  AppService _appService;

  CreateOfferProviderDataSourceImplement(this._appService);
  ...
  Future<WithOutDataResponse> createOfferProvider(
    ...
    return await _appService.createOfferProvider(
