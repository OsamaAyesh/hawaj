...
abstract class  RegisterMyCompanyOfferProviderDataSource {
  Future<WithOutDataResponse> registerMyCompanyOfferProvider(
      RegisterMyCompanyOfferProviderRequest request);
}

class RegisterMyCompanyOfferProviderDataSourceImplement
    implements RegisterMyCompanyOfferProviderDataSource {
  AppService _appService;

  RegisterMyCompanyOfferProviderDataSourceImplement(this._appService);
  ...
  Future<WithOutDataResponse> registerMyCompanyOfferProvider(
    ...
    return await _appService.registerMyCompanyOfferProviderRequest(
