...
class RegisterMyCompanyOfferProviderRequest {
  ...
  RegisterMyCompanyOfferProviderRequest({
  ...
  Future<FormData> prepareFormData() async {
    ...
    if (organizationServices?.isNotEmpty ?? false) {
      formData.fields.add(MapEntry('organization_services', organizationServices!));
    }
    ...
    if (organizationLocation?.isNotEmpty ?? false) {
      formData.fields.add(MapEntry('organization_location', organizationLocation!));
    }
    if (organizationDetailedAddress?.isNotEmpty ?? false) {
      formData.fields.add(MapEntry('organization_detailed_address', organizationDetailedAddress!));
    }
    ...
    if (commercialRegistrationNumber?.isNotEmpty ?? false) {
      formData.fields.add(MapEntry('commercial_registration_number', commercialRegistrationNumber!));
    }
