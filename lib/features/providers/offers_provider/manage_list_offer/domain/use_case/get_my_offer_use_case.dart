...
class GetMyOfferUseCase implements BaseGetUseCase<OfferModel> {
  final GetMyOfferRepository _repository;

  GetMyOfferUseCase(this._repository);

  @override
  Future<Either<Failure, OfferModel>> execute() async {
    return await _repository.getMyOfferData();
  }
}
