...
abstract class GetMyOfferDataSource{
  Future<OfferResponse> getMyOfferData();
}

class GetMyOfferDataSourceImplement
    implements GetMyOfferDataSource {
  AppService _appService;

  GetMyOfferDataSourceImplement(this._appService);
  ...
  Future<OfferResponse> getMyOfferData(
    ...
    return await _appService.getMyOffer(
    );
  }
}
